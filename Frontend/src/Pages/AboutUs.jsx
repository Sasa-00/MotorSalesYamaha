...
const AboutUs = () => {
  ...
  const { ref: myRef1, inView: divIsVisible1 } = useInView(oprions);
  const { ref: myRef2, inView: divIsVisible2 } = useInView(oprions);
  const { ref: myRef3, inView: divIsVisible3 } = useInView(oprions);
  const { ref: myRef4, inView: divIsVisible4 } = useInView(oprions);
  const { ref: myRef5, inView: divIsVisible5 } = useInView(oprions);
  const { ref: myRef6, inView: divIsVisible6 } = useInView(oprions);
  const { ref: myRef7, inView: divIsVisible7 } = useInView(oprions);
  const { ref: myRef8, inView: divIsVisible8 } = useInView(oprions);
  const { ref: myRef9, inView: divIsVisible9 } = useInView(oprions);
  ...
  return (
    <div className='about-gradient'>
      <div className='about-container'>
        ...
        <hr />
        <br /><br />
        <div ref={myRef1} className={divIsVisible1? 'appear about-card': 'about-card'}>
        ...
        <div ref={myRef2} className={divIsVisible2? 'appear about-card': 'about-card'}>
        ...
        <div ref={myRef3} className={divIsVisible3? 'appear about-card': 'about-card'}>
        ...
        <div ref={myRef4} className={divIsVisible4? 'appear about-card': 'about-card'}>
        ...
        <div ref={myRef5} className={divIsVisible5? 'appear about-card': 'about-card'}>
        ...
        <div ref={myRef6} className={divIsVisible6? 'appear about-card': 'about-card'}>
        ...
        <div ref={myRef7} className={divIsVisible7? 'appear about-card': 'about-card'}>
        ...
        <div ref={myRef8} className={divIsVisible8? 'appear about-card': 'about-card'}>
        ...
        <div ref={myRef9} className={divIsVisible9? 'appear about-card': 'about-card'}>
